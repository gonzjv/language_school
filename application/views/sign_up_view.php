            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone" placeholder="Phone number like +375 29 1112233" required>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="passConfirm" id="pass_confirm" placeholder="Confirm password" >
                    </div>
                </div>-->
